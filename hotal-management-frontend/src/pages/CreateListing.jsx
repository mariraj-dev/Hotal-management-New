...
const CreateListing = () => {
  ...
  const handlePost = async (e) => {
    ...
    try {
      ...
      console.log("formLocation.streetAddress",formLocation.streetAddress);
      ...
      let payload = {
        ...
        "listingphotos": data.get('listingPhotos'),
      }
      ...
      const response = await fetch("http://localhost:3001/api/v1/hotal-management/features", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        console.log("tryfxgfxgsdfgsdfgdgsdfg");
        // navigate("/");
      }
    } catch (err) {
